...
* Editing variable names (to be descriptive for the coder) and print text (to be descripted to anyone viewing the analysis results) to match the data in the relevant election data file (e.g., changing county to township):
